...
limited to 64 KiB. Discovery uses the public `@dwg/skill-contracts` and
`@dwg/cad-capabilities` package entrypoints only; it must never import CAD
runtime, parser, HTTP, MCP, workspace, or provider internals.
